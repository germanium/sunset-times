...
U{Paul Schlyter<http://stjarnhimlen.se/english.html>}, December 1992
			 
Direct conversion to Java 
U{Sean Russell<ser@germane-software.com>}

Conversion to Python Class, 2002-03-21
U{Henrik Härkönen<radix@kortis.to>}

 - Solar Altitude added by Miguel Tremblay 2005-01-16
 - Solar flux, equation of time and import of python library
   added by U{Miguel Tremblay<http://ptaff.ca/miguel/>} 2007-11-22

Source available at U{Henrik's Python page<http://kortis.to/radix/python/>}
"""
...
class Sun:
	...
	Note:
	 ...
	 - *set  = where to store the set  time 
         ...
         - Return value:
         - 0 = sun rises/sets this day, times stored at
         *trise and *tset.
    ...
    def equation_of_time(self, year, month, day, latitude):
        ...
        @param day: Day
        @type latitude: float
        @param latitude: latitude to comput the equation of time


        @rtype: tuple
        @return: (double fEot, double fR0r, tuple tDeclsc)
    ...
    def __Solcons(self, dAlf):
        ...
        @type dAlf: double
        @param dAlf: Solar constant to correct the excentricity

        @rtype: double
        @return: Variation of the solar constant
        """
